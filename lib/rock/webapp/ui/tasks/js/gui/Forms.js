...
function generateForm(url,portinfo,id){
	...
	submit.setAttribute("onclick","sendForm(\"form"+id+ "\",WebSockets.sendJSON)")
	form.appendChild(submit);
	
	var disconnect = document.createElement("input");
	disconnect.setAttribute("type","button");
	disconnect.setAttribute("value","disconnect");
	disconnect.setAttribute("onclick","WebSockets.get(\""+url+ "\").close()")
